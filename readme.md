...
# Time Tracker with CSV in Python

Works with a comma-separated values(CSV) file, and it stores data on the time values of the clients from CLI.
...
* **GitHub Discussions:** [Open a discussion](https://github.com/gutiluis/Trime-tracker/discussions)
